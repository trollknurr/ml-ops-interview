# Collection of ML Ops interview questions (en/ru)

#### Алгоритмы и структуры данных

* Одно и двусвязные списки, как это и зачем нужны
* Как обрабатываются коллизии в хэш-таблице
    *  Зачем нужны массивы, если есть хэш-таблицы
* Quicksort 
    * Какие еще сортировки знаете
* Какая сортировка в Python (insert + merge) 
...
* Как работает CPU, память, диск
    * Кэш процессора и RAM
    * Запись на диск происходит по write?
